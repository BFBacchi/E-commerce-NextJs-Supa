      ...
      <div className="max-w-md w-full">
        <div className="bg-card rounded-xl shadow-lg p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-2 border border-border rounded-lg hover:bg-card transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
